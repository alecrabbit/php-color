...
namespace AlecRabbit\Tests\TestCase\Mixin;
...
trait AppRelatedConstTrait
{
    ...
    final protected const GREEN = 'green';
    final protected const HEX = 'hex';
    final protected const HUE = 'hue';
    ...
    final protected const LIGHTNESS = 'lightness';
    ...
    final protected const OPACITY = 'opacity';
