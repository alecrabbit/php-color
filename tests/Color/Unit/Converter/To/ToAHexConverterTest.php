...
use AlecRabbit\Color\Converter\To\ToAHexConverter;
...
final class ToAHexConverterTest extends TestCase
{
    #[Test]
    public function canBeInstantiated(): void
    {
        ...
        self::assertInstanceOf(ToAHexConverter::class, $toConverter);
    }

    private function getTesteeInstance(
        ?IRegistry $registry = null,
    ): IToConverter {
        return new ToAHexConverter(
    ...
    {
        $class = ToAHexConverter::class;
        $targets = $class::getTargets();

        self::assertCount(3, $targets);
        self::assertContains(IAHexColor::class, $targets);
        self::assertContains(AHex::class, $targets);
        self::assertContains(DRGB::class, $targets);
    }
}
