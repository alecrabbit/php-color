...
class Hex8Test extends TestCase
{
    ...
    private static function canBeCreatedFromStringDataFeeder(): iterable
    {
        yield from [
            // (resulting)[value, r, g, b, o, a, toString], (incoming)[value]
            [[0xFF00FF, 0xFF, 0x00, 0xFF, 1.0, 0xFF, '#ff00ffff'], ['#ff00ff']],
            [[0x00FF00, 0x00, 0xFF, 0x00, 1.0, 0xFF, '#00ff00ff'], ['#00ff00']],
            [[0x0000FF, 0x00, 0x00, 0xFF, 1.0, 0xFF, '#0000ffff'], ['#0000ff']],
            [[0x000000, 0x00, 0x00, 0x00, 1.0, 0xFF, '#000000ff'], ['#000000']],
            [[0xFFFFFF, 0xFF, 0xFF, 0xFF, 1.0, 0xFF, '#ffffffff'], ['#ffffff']],
            [[0xFFFFFF, 0xFF, 0xFF, 0xFF, 1.0, 0xFF, '#ffffffff'], ['ffffff']],
            [[0xFFFFFF, 0xFF, 0xFF, 0xFF, 1.0, 0xFF, '#ffffffff'], ['fff']],
            [[0xFFFFFF, 0xFF, 0xFF, 0xFF, 1.0, 0xFF, '#ffffffff'], ['#fff']],
            [[0x110000, 0x11, 0x00, 0x00, 1.0, 0xFF, '#110000ff'], ['#110000']],
            [[0x00ae00, 0x00, 0xae, 0x00, 1.0, 0xFF, '#00ae00ff'], ['#00ae00']],
        ];
    }
